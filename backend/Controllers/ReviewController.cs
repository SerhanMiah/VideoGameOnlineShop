...
namespace VideoGameAppBackend.Controllers
{
    ...
    public class ReviewController : ControllerBase
    {
        ...
        public ReviewController(GameDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Review>>> GetReviews()
        {
            return await _context.Reviews
                .Include(r => r.User) // Include user details when fetching reviews
                .ToListAsync();
        }
        ...
        public async Task<ActionResult<Review>> GetReview(int id)
        {
            var review = await _context.Reviews
                .Include(r => r.User) // Include user details when fetching a single review
